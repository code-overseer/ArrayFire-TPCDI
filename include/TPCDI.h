...
public:
    ...
    Customer(AFDataFrame *newC, AFDataFrame *addA, AFDataFrame *updA, AFDataFrame *closeA, AFDataFrame *updC,
             AFDataFrame *in) :
...
AFDataFrame
loadDimCompany(AFDataFrame &s_Company, AFDataFrame &industry, AFDataFrame &statusType, AFDataFrame &dimDate);
